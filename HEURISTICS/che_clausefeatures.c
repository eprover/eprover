...
void ClauseInfoPrint(FILE* out, Clause_p clause)
{
   fprintf(out, "info(%ld, %ld, %ld, %ld, %ld, %d, %ld, %ld)",
      ...
      clause->proof_depth,
      clause->proof_size,
      (long)ClauseWeight(clause, 1, 1, 1, 1, 1, 1, 1, false),
      ClauseDepth(clause),
      ClauseLiteralNumber(clause),
      (long)ClauseWeight(clause, 0, 1, 1, 1, 1, 1, 1, false),
...
void ClausePropInfoPrint(FILE* out, Clause_p clause)
{
   ...
   fprintf(out,
      ...
      (long)ClauseSymTypeWeight(clause, 1,1,1,1,1,1,1,1,1),
      (long)ClauseSymTypeWeight(clause, 1,1,1,0,1,0,0,1,1),
      (long)ClauseSymTypeWeight(clause, 1,1,1,1,0,0,0,1,1),
      (long)ClauseSymTypeWeight(clause, 1,1,1,0,0,1,0,1,1),
      (long)ClauseSymTypeWeight(clause, 1,1,1,0,0,0,1,1,1),
      ClauseDepth(clause),
      ClauseLiteralNumber(clause),
      clause->pos_lit_no,
      clause->neg_lit_no);
