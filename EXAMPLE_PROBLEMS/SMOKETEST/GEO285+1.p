%------------------------------------------------------------------------------
% File     : GEO285+1 : TPTP v7.0.0. Released v4.1.0.
% Domain   : Geometry
...
% Status   : Theorem
% Rating   : 0.61 v7.0.0, 0.57 v6.4.0, 0.62 v6.2.0, 0.68 v6.1.0, 0.70 v5.5.0, 0.78 v5.4.0, 0.79 v5.3.0, 0.81 v5.2.0, 0.65 v5.1.0, 0.67 v5.0.0, 0.79 v4.1.0
% Syntax   : Number of formulae    :  133 (   6 unit)
%            Number of atoms       : 1273 ( 521 equality)
%            Maximal formula depth :   46 (  12 average)
%            Number of connectives : 1300 ( 160   ~;  12   |; 991   &)
%                                         (   8 <=>; 129  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   0 propositional; 1-3 arity)
%            Number of functors    :   28 (  21 constant; 0-4 arity)
%            Number of variables   :  750 (   0 sgn; 483   !; 267   ?)
