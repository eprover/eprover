%------------------------------------------------------------------------------
% File     : GEO341+1 : TPTP v7.0.0. Released v4.1.0.
% Domain   : Geometry
...
% Status   : Theorem
% Rating   : 0.83 v7.0.0, 0.90 v6.4.0, 0.85 v6.3.0, 0.88 v6.2.0, 0.92 v6.1.0, 0.93 v6.0.0, 0.91 v5.5.0, 0.96 v5.4.0, 0.93 v5.3.0, 0.96 v5.2.0, 0.90 v5.0.0, 0.92 v4.1.0
% Syntax   : Number of formulae    :  123 (   9 unit)
%            Number of atoms       : 1361 ( 574 equality)
...
%            Number of functors    :   18 (  10 constant; 0-8 arity)
%            Number of variables   :  842 (   0 sgn; 542   !; 300   ?)
