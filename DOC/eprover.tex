...
\author{Stephan Schulz}
\title{E 2.4\\[1.5ex]User Manual\\[1.5ex]{\normalsize --preliminary
    version--}}
...
\begin{abstract}
  ...
  superposition and rewriting. In this preliminary manual we first
  give a short introduction for impatient new users, and then cover
  calculus and proof procedure. The manual also covers proof search
  control and related options, followed by input and output
...
\texttt{README} in the main directory of the distribution contains the
necessary information. After configuring and building the system, you
will find the stand-alone executable \texttt{E/PROVER/eprover}, or
...
\begin{appendix}
  ...
  (version 2.1 or later). You may also have bought a proprietary
...
\newblock In Pacal Fontaine, editor, {\em Proc.\ of the 27th CADE, Natal,
