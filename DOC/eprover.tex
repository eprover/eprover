...
If you use problems in the current version of the TPTP language, you
...
\begin{tabular}{lp{5.8cm}}
  ...
  (E-LOP, TPTP-1/2 or TPTP-3/TSTP). Just write down a list of
  clauses.\\
...
from the E web site~\cite{E:WWW-04} and/or check out the examples
