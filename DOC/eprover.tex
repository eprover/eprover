...
\author{Stephan Schulz}
\title{\includegraphics[width=4cm]{eicon333.png}\\[5ex]E 2.5\\[1.5ex]User Manual\\[1.5ex]{\normalsize --preliminary
    version--}}
...
\texttt{README} (or \texttt{README.md}) in the main directory of the
distribution contains the necessary information. After configuring and
building the system, you will find the stand-alone executable
...
\begin{appendix}
  ...
  Joseph Urban, who is a profligate user, proselytizer and occasional
  hacker.
  ...
  to. If you are in doubt about which version of E you have, run
  \texttt{eprover -V} or \texttt{eprover -h}\index{GPL}\index{GNU
    General Public License}\index{LGPL}\index{GNU Lesser General
    Public License}.
